...
class gameFinaleClass():
    ...
    def frame5(self): #Waffe wird ausgefuehrt
        ...
        for i in range(1, 1000, 3):  #for schleife fuer den Lazzer fuer den bereich von 1 bis 1000 in abstaenden von 3 zueinander dargestellt,
            circle(i,400+sin(self.a)*80, 10) #kries wird fuer x mit i und fuer y mit: 400+sin(self.a)*80: stellt die winkelverschiebung der Sinuswelle von 0 auf etwa 30 Grad dar und +400 um im auf der y achse im bild zu sein
